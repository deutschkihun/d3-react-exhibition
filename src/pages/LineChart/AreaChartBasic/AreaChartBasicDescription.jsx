...
export function AreaChartBasicDescription() {
  return (
    <Explanation>
      <Pre>
        <code>
          ...
          <br />
          <br />
          <span>Ex.) Coca cola stock evolution with area</span>
          <br />
          <br />
          ...
          <br />
          <span>{'             .y0(y(d3.min(data, function(d) { return d.value; })-3))'}</span>
          <br />
          <span>{'             .y1(function(d) { return y(d.value) }))'}</span>
          <br />
        </code>
      </Pre>
    </Explanation>
