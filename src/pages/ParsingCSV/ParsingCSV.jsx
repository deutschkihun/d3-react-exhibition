...
export function Parsingcsv() {
  ...
  return (
    <VizWrapper>
      ...
      <VizContainer>
        <Message>
          After parsing csv file, we will get a following result. For efficiency use d3.csv to parse csv file.
        </Message>
      ...
      <VizContainer>
        ...
        <StraightColorViz data={data} />
      </VizContainer>
      <VizContainer>
        <Message>Rendering all color data with d3.arc and d3.pie.</Message>
        <CurvedColorViz data={data} height={height} margin={margin} />
      </VizContainer>
    </VizWrapper>
  )
}
