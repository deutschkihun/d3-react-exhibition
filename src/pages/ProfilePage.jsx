    ...
    return (
            <Wrapper>
                    ...
                    <Message>
                        ...
                        <img className="icon" src={person} alt="person" onClick={() => window.location.assign('https://deutschkihun.com')} />
                        <img className="icon" src={mail} alt="mail" onClick={() => window.location.assign('mailto:deutschkihun@gmail.com')} />
                        <img className="icon" src={linkedin} alt="linkedin" onClick={() => window.location.assign('https://www.linkedin.com/in/kihun-kim-b35b73174/')} />
                        <img className="icon" src={github} alt="github" onClick={() => window.location.assign('https://github.com/deutschkihun')}/>
            </Wrapper>
    )
}
