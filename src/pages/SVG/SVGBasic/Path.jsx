...
export const Path = () => {
  ...
  return (
    ...
    <VizContainer>
      ...
      <Message> M: starting point of drawing, L: line drawing, set value to draw first line from M, 
                H: horizontal line, V: vertical line, Z: finish rest line, C: curve (start,adjust point (curving point) end)
      </Message>
      <svg viewBox='0 0 1500 500' style={{background: '#ddd'}}>
        <g className="g1">
            <path id='sample' d="M 300 200 L 500 100 H 50 V 300 Z"></path>
            <path id='sample' d="M 500 150 C 500 150 900 500 500 300 Z"></path>
            <path id='sample' d="M 10 10 L 50 100 H 300 V 500 Z"></path>
        </g>
      </svg>
