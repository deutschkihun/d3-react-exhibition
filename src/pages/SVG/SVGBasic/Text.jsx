...
export function Text() {
  useEffect(() => {
    d3.select('text').attr('fill', 'blue').attr('font-size', '15')

    d3.selectAll('.strong').attr('fill', 'black').attr('font-weight', 'bold')
  }, [])
  ...
  return (
    <>
      <VizContainer>
        ...
        <Message>
          Writing dynamic text component with svg. x: the x coordinate of the starting point, y: the y coordinate of the
          starting point. default is zero. Use defs to save graphic object such as path and connect with textPath href.
        </Message>
        <svg viewBox="0 0 1000 500">
          <defs>
            <path id="text-curve" d="M 50 100 C 50 100, 400 600, 500 400 C 500 400, 600 -400, 1000 600" />
          </defs>
          <text x="0" y="0">
